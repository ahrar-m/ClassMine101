...
- Run the build command in terminal and prepare a localhost preview link (e.g. `http://127.0.0.1:8000` or `http://localhost:8000`) and present it directly so the user can click and open it to analyze locally.
